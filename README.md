...
Design, University of Lleida (UdL), Jaume II 69, 25001 Lleida, Spain.
...
under an energy model that includes the **network-routing cost** of migrations. It is compared,
in the same simulator, against classical baselines (MU/MMT/RS/MC/WPSP) and two recent (2025)
methods, **AMOVMC** and **EUQ-VMC**.
...
**Contact:** Dr. Vitor Luiz da Silva Verbel — vitor.dasilva@udl.cat
